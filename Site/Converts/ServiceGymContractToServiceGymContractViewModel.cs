...
{
    public class ServiceGymContractToServiceGymContractViewModel : IMapper<ServiceGymContract, ServiceGymContractViewModel>
    {
        public void Map(ServiceGymContract source, ServiceGymContractViewModel destination)
        {
            if (source == null)
            {
